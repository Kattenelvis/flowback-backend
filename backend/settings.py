...
if FLOWBACK_URL and env('URL_USER_CREATE') and env('URL_USER_FORGOT_PASSWORD'):
    URL_USER_CREATE = 'http://' + FLOWBACK_URL + env('URL_USER_CREATE')
    URL_USER_FORGOT_PASSWORD = 'http://' + FLOWBACK_URL + env('URL_USER_FORGOT_PASSWORD')
